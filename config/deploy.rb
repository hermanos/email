...
set :shared_paths, ['config/database.yml', 'log', 'tmp', 'public/attachments']
...
task :setup => :environment do
  ...
  queue! %[mkdir -p "#{deploy_to}/shared/public/attachments"]
  queue! %[chmod g+rx,u+rwx "#{deploy_to}/shared/public/attachments"]
